...
import ch.uzh.ifi.seal.soprafs19.entity.WebMessage;
import ch.uzh.ifi.seal.soprafs19.entity.User;
import ch.uzh.ifi.seal.soprafs19.repository.UserRepository;
import ch.uzh.ifi.seal.soprafs19.service.NotificationService;
...
//    public ResponseEntity<?> someAction(@RequestBody String target) {
        ...
        WebMessage notification = new WebMessage("Hello, World!");
